...
class _SubMenuPageState extends State<SubMenuPage> {
  ...
  late var desc =
      '"Tasty, delicious, and has me craving more on the first bite." to "Juicy, mounthwatering, tasty and everything you\'d ever want to savor."';
  @override
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Center(
            child: Text(
              "lighting fast delivery within 10-12 min",
              style: TextStyle(
                  color: Colors.black.withOpacity(0.7),
                  fontSize: 14,
                  fontWeight: FontWeight.w300,
